...
cv2.createTrackbar('L - h', 'panel', 136, 179, nothing)
cv2.createTrackbar('U - h', 'panel', 200, 200, nothing)

cv2.createTrackbar('L - s', 'panel', 000, 255, nothing)
cv2.createTrackbar('U - s', 'panel', 30, 255, nothing) #018
 
cv2.createTrackbar('L - v', 'panel', 126, 255, nothing)
